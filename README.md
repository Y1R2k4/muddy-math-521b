...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/muddy-math-521b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/muddy-math-521b
```

A live public deployment of this template is available at [https://muddy-math-521b.templates.workers.dev](https://muddy-math-521b.templates.workers.dev)
